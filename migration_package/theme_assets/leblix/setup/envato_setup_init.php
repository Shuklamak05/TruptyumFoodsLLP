...
if ( ! function_exists( 'envato_theme_setup_wizard' ) ) :
	function envato_theme_setup_wizard() {
		...
		if ( class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
			class leblix_Envato_Theme_Setup_Wizard extends Envato_Theme_Setup_Wizard {
				...
				public function get_default_theme_style() {
					return class_exists( 'leblix_Theme_Manager_custom' ) ? leblix_Theme_Manager_custom::get_instance()->default_color : 'white';
				}
			...
			leblix_Envato_Theme_Setup_Wizard::get_instance();
		}
	}
endif;
