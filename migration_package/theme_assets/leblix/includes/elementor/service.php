 ...
 */
class CSPT_ServiceElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'cspt_service_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'Leblix Service Element', 'leblix' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Service Category?', 'leblix' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Service Category ?', 'leblix' ),
				'description' => esc_attr__( 'Select YES to show sortable Service Category.', 'leblix' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'leblix' ),
				'label_off' => esc_attr__( 'No', 'leblix' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> cspt_element_template_list( 'service', true ),
			]
		);
		$this->end_controls_section();
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cspt-ele-header-area">
				...
				if( function_exists('cspt_sortable_category') ){
					$sortable_html = cspt_sortable_category( $settings, 'cspt-service-category' );
	...
	protected function select_category() {
	  	$category = get_terms( array( 'taxonomy' => 'cspt-service-category', 'hide_empty' => false ) );
	  	$cat = array();
...
Plugin::instance()->widgets_manager->register( new CSPT_ServiceElement() );
