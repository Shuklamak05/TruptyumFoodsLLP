 ...
 */
class CSPT_BlogElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'cspt_blog_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'Leblix Blog Element', 'leblix' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Blog Category?', 'leblix' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Blog Category ?', 'leblix' ),
				'description' => esc_attr__( 'Select YES to show sortable Blog Category.', 'leblix' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'leblix' ),
				'label_off' => esc_attr__( 'No', 'leblix' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'pagination',
			[
				'label' => esc_attr__( 'Show Pagination ?', 'leblix' ),
				'description' => esc_attr__( 'Select YES to Show pagination links below blog boxes.', 'leblix' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'leblix' ),
				'label_off' => esc_attr__( 'No', 'leblix' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Blog View Style', 'leblix' ),
				'description'	=> esc_attr__( 'Slect Blog View style.', 'leblix' ),
				'type'			=> 'cspt_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> cspt_element_template_list( 'blog', 'elementor' ),
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cspt-ele-header-area">
				...
				if( function_exists('cspt_sortable_category') ){
					$sortable_html = cspt_sortable_category( $settings, 'category' );
			...
			<?php
				...
				if( isset($settings['pagination']) && $settings['pagination']=='yes' && $settings['view-type']!='carousel' ){
					$return .= cspt_pagination( $posts );
				}
		} else {
			echo esc_html__( 'No posts found', 'leblix');
		}
...
Plugin::instance()->widgets_manager->register( new CSPT_BlogElement() );
