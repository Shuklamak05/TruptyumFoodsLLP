 ...
 */
class CSPT_MultipleIconHeading extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'cspt_multiple_icon_heading';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'Leblix Multiple Icon Heading Element', 'leblix' );
	}
            ...
            [
				...
				'default'		=> array (
					array (
						...
						'title'			=> esc_attr__('Welcome to our site', 'leblix'),
						'subtitle'		=> esc_attr__('This is subtitle', 'leblix'),
						'btn_title'		=> esc_attr__('Read More', 'leblix'),
						'box_number'	=> '',
...
Plugin::instance()->widgets_manager->register( new CSPT_MultipleIconHeading() );