 ...
 */
class CSPT_TestimonialElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'cspt_testimonial_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'Leblix Testimonial Element', 'leblix' );
	}
	...
	public function __construct($data = [], $args = null) {
		...
		if( isset($data['settings']["sortable"]) && !empty($data['settings']["sortable"]) && $data['settings']["sortable"]=='yes' ){
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Testimonial Category?', 'leblix' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Testimonial Category ?', 'leblix' ),
				'description' => esc_attr__( 'Select YES to show sortable Testimonial Category.', 'leblix' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'leblix' ),
				'label_off' => esc_attr__( 'No', 'leblix' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Testimonial View Style', 'leblix' ),
				'description'	=> esc_attr__( 'Slect Testimonial View style.', 'leblix' ),
				'type'			=> 'cspt_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> cspt_element_template_list( 'testimonial', true ),
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		if ( $posts->have_posts() ) {
			...
			if( $settings['style'] =='1'){?>
			<div class="row">
				<div class="cspt-tbox-left col-sm-4">
					<?php cspt_heading_subheading($settings, true);  ?>
					<div class="cspt-carousel-navs">
						<a href="#" class="cspt-carousel-prev"><i class="cspt-base-icon-left-arrow-1"></i></a>
						<a href="#" class="cspt-carousel-next"><i class="cspt-base-icon-next"></i></a>
					</div>
				</div>
				<?php	} else { ?>
				<div class="cspt-ele-header-area">
					...
					if( function_exists('cspt_sortable_category') ){
						$sortable_html = cspt_sortable_category( $settings, 'cspt-testimonial-cat' );
				...
				<?php if( $settings['style'] =='1' ){ ?>
					<div class="cspt-tbox-right col-sm-8">
				<?php } ?>
	...
	protected function select_category() {
        $category = get_terms( array( 'taxonomy' => 'cspt-testimonial-cat', 'hide_empty' => false ) );
	  	$cat = array();
...
Plugin::instance()->widgets_manager->register( new CSPT_TestimonialElement() );
