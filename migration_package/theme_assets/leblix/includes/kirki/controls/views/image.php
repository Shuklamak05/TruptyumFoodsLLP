...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'leblix' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'leblix' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'leblix' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'leblix' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'leblix' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'leblix' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'leblix' ); ?>',
} );
#>
