	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'leblix' ),
				'remove'               => esc_html__( 'Remove', 'leblix' ),
				'default'              => esc_html__( 'Default', 'leblix' ),
				'selectFile'           => esc_html__( 'Select File', 'leblix' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'leblix' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'leblix' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'leblix' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'leblix' ),
			)
		);
