...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'leblix' ),
				'change'       => esc_html__( 'Change image', 'leblix' ),
				'default'      => esc_html__( 'Default', 'leblix' ),
				'remove'       => esc_html__( 'Remove', 'leblix' ),
				'placeholder'  => esc_html__( 'No image selected', 'leblix' ),
				'frame_title'  => esc_html__( 'Select image', 'leblix' ),
				'frame_button' => esc_html__( 'Choose image', 'leblix' ),
			)
		);
	}
