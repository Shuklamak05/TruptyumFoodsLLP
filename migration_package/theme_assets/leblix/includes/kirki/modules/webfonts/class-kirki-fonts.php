...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'leblix' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'leblix' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'leblix' ),
			'200'       => esc_html__( 'Light 200', 'leblix' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'leblix' ),
			'300'       => esc_html__( 'Book 300', 'leblix' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'leblix' ),
			'400'       => esc_html__( 'Normal 400', 'leblix' ),
			'regular'   => esc_html__( 'Normal 400', 'leblix' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'leblix' ),
			'500'       => esc_html__( 'Medium 500', 'leblix' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'leblix' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'leblix' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'leblix' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'leblix' ),
			'700'       => esc_html__( 'Bold 700', 'leblix' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'leblix' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'leblix' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'leblix' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'leblix' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'leblix' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'leblix' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'leblix' ),
		);
	}
